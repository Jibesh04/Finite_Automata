...
int even_0_odd_1(char str[], int len){
...
int main(){
    ...
    printf("%s contains even 0's and odd 1's: %s\n", str, even_0_odd_1(str, len) ? "YES" : "NO");
    return 0;
}

/* TERMINAL
PS D:\Junior\Study\Finite_Automata\Lab3_24.01.2023> gcc -o even_0_odd_1.exe .\even_0_odd_1.c
PS D:\Junior\Study\Finite_Automata\Lab3_24.01.2023> .\even_0_odd_1.exe
Enter the length of the string: 5
Enter the string: 10010
10010 contains even 0's and odd 1's: NO
PS D:\Junior\Study\Finite_Automata\Lab3_24.01.2023> .\even_0_odd_1.exe
Enter the length of the string: 5
Enter the string: 01101
01101 contains even 0's and odd 1's: YES
*/